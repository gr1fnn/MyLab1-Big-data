...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Вкладка 4: Расширенный анализ (Общая + самостоятельная часть)
        self.tabAdvanced = QWidget()
        self.tabAdvanced.setObjectName(u"tabAdvanced")
        self.verticalLayout_5 = QVBoxLayout(self.tabAdvanced)
        self.verticalLayout_5.setObjectName(u"verticalLayout_5")
        
        # Общая часть (mpg)
        self.groupBoxGeneral = QGroupBox(self.tabAdvanced)
        self.groupBoxGeneral.setObjectName(u"groupBoxGeneral")
        
        self.generalLayout = QVBoxLayout(self.groupBoxGeneral)
        
        self.generalLabel = QLabel(self.groupBoxGeneral)
        self.generalLabel.setObjectName(u"generalLabel")
        self.generalLayout.addWidget(self.generalLabel)
        
        self.analyzeMpgButton = QPushButton(self.groupBoxGeneral)
        self.analyzeMpgButton.setObjectName(u"analyzeMpgButton")
        self.generalLayout.addWidget(self.analyzeMpgButton)
        
        self.hypothesisTestButton = QPushButton(self.groupBoxGeneral)
        self.hypothesisTestButton.setObjectName(u"hypothesisTestButton")
        self.hypothesisTestButton.setEnabled(False)
        self.generalLayout.addWidget(self.hypothesisTestButton)
        
        self.gradientDescentButton = QPushButton(self.groupBoxGeneral)
        self.gradientDescentButton.setObjectName(u"gradientDescentButton")
        self.gradientDescentButton.setEnabled(False)
        self.generalLayout.addWidget(self.gradientDescentButton)
        
        self.verticalLayout_5.addWidget(self.groupBoxGeneral)
        
        # Самостоятельная часть (ваши данные)
        self.groupBoxIndependent = QGroupBox(self.tabAdvanced)
        self.groupBoxIndependent.setObjectName(u"groupBoxIndependent")
        
        self.independentLayout = QVBoxLayout(self.groupBoxIndependent)
        
        self.independentLabel = QLabel(self.groupBoxIndependent)
        self.independentLabel.setObjectName(u"independentLabel")
        self.independentLayout.addWidget(self.independentLabel)
        
        self.exploratoryAnalysisButton = QPushButton(self.groupBoxIndependent)
        self.exploratoryAnalysisButton.setObjectName(u"exploratoryAnalysisButton")
        self.exploratoryAnalysisButton.setEnabled(False)
        self.independentLayout.addWidget(self.exploratoryAnalysisButton)
        
        self.correlationAnalysisButton = QPushButton(self.groupBoxIndependent)
        self.correlationAnalysisButton.setObjectName(u"correlationAnalysisButton")
        self.correlationAnalysisButton.setEnabled(False)
        self.independentLayout.addWidget(self.correlationAnalysisButton)
        
        self.verticalLayout_5.addWidget(self.groupBoxIndependent)
        
        # Вывод расширенного анализа
        self.advancedOutput = QTextEdit(self.tabAdvanced)
        self.advancedOutput.setObjectName(u"advancedOutput")
        self.advancedOutput.setReadOnly(True)
        self.verticalLayout_5.addWidget(self.advancedOutput)
    ...
    def retranslateUi(self, MainWindow):
        ...
        # Вкладка 4
        self.groupBoxGeneral.setTitle(QCoreApplication.translate("MainWindow", u"Общая часть: Анализ данных mpg", None))
        self.generalLabel.setText(QCoreApplication.translate("MainWindow", u"Разведочный анализ набора данных mpg из библиотеки Seaborn", None))
        self.analyzeMpgButton.setText(QCoreApplication.translate("MainWindow", u"Загрузить и проанализировать mpg", None))
        self.hypothesisTestButton.setText(QCoreApplication.translate("MainWindow", u"Проверить гипотезы", None))
        self.gradientDescentButton.setText(QCoreApplication.translate("MainWindow", u"Градиентный спуск", None))
        self.groupBoxIndependent.setTitle(QCoreApplication.translate("MainWindow", u"Самостоятельная часть: Анализ ваших данных", None))
        self.independentLabel.setText(QCoreApplication.translate("MainWindow", u"Расширенный анализ объединенной таблицы", None))
        self.exploratoryAnalysisButton.setText(QCoreApplication.translate("MainWindow", u"Разведочный анализ", None))
        self.correlationAnalysisButton.setText(QCoreApplication.translate("MainWindow", u"Корреляционный анализ", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabAdvanced), QCoreApplication.translate("MainWindow", u"Расширенный анализ", None))